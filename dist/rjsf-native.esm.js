...
var FieldTemplate = function FieldTemplate(_ref) {
  ...
  }), (rawHelp === null || rawHelp === void 0 ? void 0 : rawHelp.length) > 0 && React.createElement(Text, {
...
var ObjectFieldTemplate = function ObjectFieldTemplate(_ref) {
  ...
  return React.createElement(View, null, uiSchema['ui:title'] || title ? React.createElement(RootTitleField, {
    title: title,
    required: required
...
var DefaultFixedArrayFieldTemplate = function DefaultFixedArrayFieldTemplate(props) {
  ...
  }), (props.uiSchema['ui:description'] || props.schema.description) && React.createElement(DescriptionField, {
...
var TextWidget = function TextWidget(_ref) {
  ...
  var themedStyle = {
    borderColor: (rawErrors === null || rawErrors === void 0 ? void 0 : rawErrors.length) > 0 ? theme.errorColor : focused ? theme.highlightColor : theme.borderColor,
...
var RangeWidget = function RangeWidget(_ref) {
  ...
  }, min), React.createElement(Slider, {
